...
public void client() {
    ...
    int amount2 = 3000;
    int total = 0;
    EncryptedValue msg1 = Crypto.encrypt(new ConstructorValue("Transfer1", Arrays.asList(user, amount1, target)), "kBank");
    EncryptedValue msg2 = Crypto.encrypt(new ConstructorValue("Transfer2", Arrays.asList(user, amount2, target)), "kBank");
...
public void bank() {
    ...
    try {
        ...
        Object decrypted_2 = Crypto.decrypt(enc_1, "kBank");
