...
public class Information_flowParser extends Parser {
	...
	public static final int
		...
		RULE_format = 15, RULE_formatList = 16, RULE_expression = 17, RULE_logicalOr = 18, 
		RULE_logicalAnd = 19, RULE_equality = 20, RULE_relational = 21, RULE_additive = 22, 
		RULE_multiplicative = 23, RULE_unary = 24, RULE_primary = 25, RULE_functionCall = 26, 
		RULE_argumentList = 27, RULE_assignmentStatement = 28, RULE_ifStatement = 29, 
		RULE_elseStatement = 30, RULE_elseifStatement = 31, RULE_whileStatement = 32, 
		RULE_print = 33;
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"format", "formatList", "expression", "logicalOr", "logicalAnd", "equality", 
	...
	public final ClassBlockContext classBlock() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 18176737812480L) != 0)) {
				{
				{
				setState(90);
				statement();
	...
	public final FormatListContext formatList() throws RecognitionException {
		...
		enterRule(_localctx, 32, RULE_formatList);
		int _la;
		try {
			enterOuterAlt(_localctx, 1);
			{
