...
public class Information_flowParser extends Parser {
	...
	public static final int
		...
		T__24=25, PPLABEL=26, SEND=27, TRY_RCV=28, ENCRYPT=29, PUBLICKEY=30, PRIVATEKEY=31, 
		SECLABEL=32, INT=33, BOOL=34, STR=35, IF=36, ELSEIF=37, ELSE=38, FOR=39, 
		WHILE=40, OP=41, NOT=42, AND=43, OR=44, IDENTIFIER=45, CARRIAGE_RETURN=46, 
		QUOTE=47, NEWLINE=48, LINE_COMMENT=49;
	public static final int
		...
		RULE_type = 8, RULE_typeExpr = 9, RULE_statement = 10, RULE_returnStatement = 11, 
		RULE_encryptStatement = 12, RULE_sendStatement = 13, RULE_receiveStatement = 14, 
	...
	private static String[] makeRuleNames() {
		return new String[] {
			...
			"cmdBlock", "decls", "declItem", "type", "typeExpr", "statement", "returnStatement", 
			"encryptStatement", "sendStatement", "receiveStatement", "receivePattern", 
			"receivePatternList", "expression", "logicalOr", "logicalAnd", "equality", 
			"relational", "additive", "multiplicative", "unary", "primary", "functionCall", 
			"argumentList", "assignmentStatement", "ifStatement", "elseStatement", 
			"elseifStatement", "whileStatement", "print"
		};
	}
	...
	private static String[] makeLiteralNames() {
		return new String[] {
			...
			"'<'", "'>='", "'<='", "'+'", "'-'", "'*'", "'/'", "'%'", "'print'", 
			null, "'send'", "'try_rcv'", "'encrypt'", "'publicKey'", "'privateKey'", 
			null, null, null, null, "'if'", "'elseif'", "'else'", "'for'", "'while'", 
	...
	private static String[] makeSymbolicNames() {
		return new String[] {
			...
			null, null, null, null, null, null, null, null, null, null, null, null, 
			null, null, "PPLABEL", "SEND", "TRY_RCV", "ENCRYPT", "PUBLICKEY", "PRIVATEKEY", 
	...
	public final CmdBlockContext cmdBlock() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 40811284675652L) != 0)) {
				{
				setState(142);
				_errHandler.sync(this);
				switch (_input.LA(1)) {
	...
	public static class TypeExprContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Information_flowListener ) ((Information_flowListener)listener).enterTypeExpr(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Information_flowListener ) ((Information_flowListener)listener).exitTypeExpr(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof Information_flowVisitor ) return ((Information_flowVisitor<? extends T>)visitor).visitTypeExpr(this);
			else return visitor.visitChildren(this);
		}
	}
	...
	public static class StatementContext extends ParserRuleContext {
		...
		public EncryptStatementContext encryptStatement() {
			return getRuleContext(EncryptStatementContext.class,0);
		}
		public ExpressionContext expression() {
			return getRuleContext(ExpressionContext.class,0);
		}
	...
	@SuppressWarnings("CheckReturnValue")
	public static class EncryptStatementContext extends ParserRuleContext {
		public TerminalNode IDENTIFIER() { return getToken(Information_flowParser.IDENTIFIER, 0); }
		...
		public EncryptStatementContext(ParserRuleContext parent, int invokingState) {
			super(parent, invokingState);
		}
		@Override public int getRuleIndex() { return RULE_encryptStatement; }
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof Information_flowListener ) ((Information_flowListener)listener).enterEncryptStatement(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof Information_flowListener ) ((Information_flowListener)listener).exitEncryptStatement(this);
		}
		@Override
		public <T> T accept(ParseTreeVisitor<? extends T> visitor) {
			if ( visitor instanceof Information_flowVisitor ) return ((Information_flowVisitor<? extends T>)visitor).visitEncryptStatement(this);
			else return visitor.visitChildren(this);
		}
	}

	public final EncryptStatementContext encryptStatement() throws RecognitionException {
		EncryptStatementContext _localctx = new EncryptStatementContext(_ctx, getState());
		enterRule(_localctx, 24, RULE_encryptStatement);
		try {
			enterOuterAlt(_localctx, 1);
			{
			setState(184);
	...
	public final FunctionCallContext functionCall() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 39642550239296L) != 0)) {
				{
				setState(317);
				argumentList();
				}
