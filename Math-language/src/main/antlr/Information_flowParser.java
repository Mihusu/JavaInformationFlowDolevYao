...
public class Information_flowParser extends Parser {
	...
	public final FormatDeclarationContext formatDeclaration() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1125899906965504L) != 0)) {
				{
				setState(80);
				decls();
				}
	...
	public final ClassBlockContext classBlock() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1163345579343872L) != 0)) {
				{
				{
				setState(110);
				statement();
	...
	public final DeclarationContext declaration() throws RecognitionException {
		...
		try {
			...
			case PPLABEL:
				...
				_errHandler.sync(this);
				_la = _input.LA(1);
				while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1125899906965504L) != 0)) {
					{
					{
					setState(130);
					decls();
	...
	public final CmdBlockContext cmdBlock() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			while ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1163349874434304L) != 0)) {
				{
				setState(168);
				_errHandler.sync(this);
	...
	public final MethodCallOrFormatContext methodCallOrFormat() throws RecognitionException {
		...
		try {
			...
			_errHandler.sync(this);
			_la = _input.LA(1);
			if ((((_la) & ~0x3f) == 0 && ((1L << _la) & 1268561541922832L) != 0)) {
				{
				setState(296);
				argumentList();
				}
